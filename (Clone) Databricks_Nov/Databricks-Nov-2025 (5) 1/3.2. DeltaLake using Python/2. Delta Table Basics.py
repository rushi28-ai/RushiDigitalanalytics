...
students2_df.rdd.getNumPartitions()
...
# MAGIC %fs ls dbfs:/FileStore/delta/students/_delta_log/

# COMMAND ----------

# MAGIC %sql
# MAGIC DESC HISTORY DELTA.`dbfs:/FileStore/delta/students`
...
# MAGIC %sql
# MAGIC CREATE DATABASE IF NOT EXISTS students_db;
...
# MAGIC   action STRING
# MAGIC ) USING DELTA
# MAGIC LOCATION 'dbfs:/FileStore/delta/students';
