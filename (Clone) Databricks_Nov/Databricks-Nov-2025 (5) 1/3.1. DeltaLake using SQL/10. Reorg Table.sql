...
-- MAGIC     .withColumn("date", date_format(to_timestamp("date", 'MMddHHmm'), "2024-MM-dd HH:mm"))
...
-- MAGIC %python
-- MAGIC raw_df.rdd.getNumPartitions()
...
-- MAGIC %fs ls dbfs:/user/hive/warehouse/departure_delays/_delta_log/
...
-- MAGIC %fs head dbfs:/user/hive/warehouse/departure_delays/_delta_log/00000000000000000005.json
...
-- MAGIC %fs ls dbfs:/user/hive/warehouse/departure_delays/Is/
