...
-- MAGIC %python
-- MAGIC df_union.rdd.getNumPartitions()
...
-- MAGIC %fs ls dbfs:/user/hive/warehouse/zorder_ex1
...
-- MAGIC %fs ls dbfs:/user/hive/warehouse/zorder_ex2

-- COMMAND ----------

-- MAGIC %fs ls dbfs:/user/hive/warehouse/zorder_ex2/invoice_date=2021-01-01/
...
-- MAGIC     .withColumn("invoice_date", to_date(lit("2025-11-20")))
-- MAGIC
