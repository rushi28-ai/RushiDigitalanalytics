...
AS SELECT * FROM cloud_files("abfss://bookstore-landing@demoykrucdemodbsa.dfs.core.windows.net/books-cdc", "json")
...
FROM 
(SELECT *, explode(books) AS book FROM LIVE.orders_cleaned) o
