...
SELECT * FROM cloud_files(
  "abfss://bookstore-landing@demoykrucdemodbsa.dfs.core.windows.net/orders-json-raw", 
  "json",
...
AS 
SELECT * FROM json.`abfss://bookstore-landing@demoykrucdemodbsa.dfs.core.windows.net/customers-json`
